...
<script>
    ...
    import BaseI18nLocaleAdd from './add'
    ...
    import BaseI18nLocaleUpdate from './update'
    ...
    import BaseI18nLocaleDetail from './detail'
    import BaseI18nLocaleColumns from './baseI18nLocaleColumns'
    ...
    export default {
        name: 'BaseI18nLocaleIndexVue',
        components: {
          SectionTableColumn,
          TemplateConfirmBtn,
          BaseI18nLocaleColumns,
          BaseI18nLocaleDetail,
            CurdTableColumnSelect,
            DelBtn,
          BaseI18nLocaleUpdate,
            CurdPagination,
            HfTable, BaseI18nLocaleAdd,
          FormItemColDict,
          FormItemCol,
          SimpleSearch,
