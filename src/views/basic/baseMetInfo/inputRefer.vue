...
<script>
    ...
    export default {
        name: 'BaseMetInfoInputRefer',
        components: { BaseMetInfoColumns, CurdPagination, HfTable, SimpleSearch,
          FormItemColDict,
          FormItemCol,
          RowSpanSlot },
        props: {
            ...
            rowDbClick(row, column, event) {
                if (this.value) {
                    if (this.valueReferId) {
                        this.$set(this.value, this.valueReferId, row.metId)
                    }
                    if (this.valueReferName) {
                        this.$set(this.value, this.valueReferName, row.metTitle)
                    }
