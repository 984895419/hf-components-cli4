<template>
  <el-card class="app-container">
    ...
    <div style="margin-bottom: 10px" class="col-btn-display">
      <base-dict-type-add :action-url="conf.urlMethods.addUrl" @success="doSearch" />
...
<script>
    ...
    import BaseDictTypeAdd from './add'
    ...
    import BaseDictTypeUpdate from './update'
    ...
    import BaseDictTypeDetail from './detail'
    import BaseDictTypeColumns from './baseDictTypeColumns'
        ...
        data() {
            return {
                ...
                searchForm: {
                     ...
                     * 排序信息
                     */
                    sortInfo: [{ fieldName: 'typeId', sort: 1 }]
                },
                conf: conf,
                jsonData: {
                    list: [],
