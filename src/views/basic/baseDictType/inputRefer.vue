...
<script>
    ...
    export default {
        name: 'BaseDictTypeInputRefer',
        components: { BaseDictTypeColumns, CurdPagination, HfTable, SimpleSearch,
          FormItemColDict,
          FormItemCol,
          RowSpanSlot },
        props: {
            ...
            rowDbClick(row, column, event) {
                if (this.value) {
                    if (this.valueReferId) {
                        this.$set(this.value, this.valueReferId, row.code)
                    }
                    if (this.valueReferName) {
                        this.$set(this.value, this.valueReferName, row.name)
                    }
