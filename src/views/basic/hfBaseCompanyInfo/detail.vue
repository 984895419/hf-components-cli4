    ...
    <el-form ref="form" :model="value">
      <row-span-slot>
        <template v-slot="{ span }">
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="pkCorp" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="name" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="pkFatherorg" />
