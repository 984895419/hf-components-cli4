...
<script>
    ...
    import HfBaseCompanyInfoAdd from './add'
    ...
    import HfBaseCompanyInfoUpdate from './update'
    ...
    import HfBaseCompanyInfoDetail from './detail'
    ...
    export default {
        name: 'HfBaseCompanyInfoIndexVue',
        components: {
          SectionTableColumn,
          TemplateConfirmBtn,
          HfBaseCompanyInfoColumns,
          HfBaseCompanyInfoDetail,
            CurdTableColumnSelect,
            DelBtn,
          HfBaseCompanyInfoUpdate,
            CurdPagination,
            HfTable, HfBaseCompanyInfoAdd,
          FormItemColDict,
          FormItemCol,
          SimpleSearch,
