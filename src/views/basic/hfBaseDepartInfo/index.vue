<template>
  <el-card class="app-container">
    ...
    <div style="margin-bottom: 10px" class="col-btn-display">
      <hf-base-depart-info-add :action-url="conf.urlMethods.addUrl" @success="doSearch" />
    ...
    >
      <template v-slot="{doSave, preferenceData, headerDragend}">
        ...
        >
          ...
          <!-- 显示的字段-->
          <hf-base-depart-info-columns :show-fields="showFields" :url-methods="conf.urlMethods" @success="doSearch" />
          <el-table-column
            fixed="right"
          ...
          >
            ...
            <template slot-scope="scopeRow">
              <div class="col-btn-display">
                <!-- 更新 -->
                <hf-base-depart-info-update
                  v-permission="['hfBaseDepartInfo:update']"
                  :value="scopeRow.row"
                ...
                <!-- 删除-->
                <del-btn
                  v-permission="['hfBaseDepartInfo:delete']"
...
<script>
    ...
    import HfBaseDepartInfoAdd from './add'
    ...
    import HfBaseDepartInfoUpdate from './update'
    ...
    import HfBaseDepartInfoDetail from './detail'
    import HfBaseDepartInfoColumns from './hfBaseDepartInfoColumns'
    ...
    export default {
        name: 'HfBaseDepartInfoIndexVue',
        components: {
          SectionTableColumn,
          TemplateConfirmBtn,
          HfBaseDepartInfoColumns,
          HfBaseDepartInfoDetail,
            CurdTableColumnSelect,
            DelBtn,
          HfBaseDepartInfoUpdate,
            CurdPagination,
            HfTable, HfBaseDepartInfoAdd,
          FormItemColDict,
          FormItemCol,
          SimpleSearch,
