<template>
  <el-card class="app-container">
    ...
    <div style="margin-bottom: 10px" class="col-btn-display">
      <base-handler-mapping-controller-add :action-url="conf.urlMethods.addUrl" @success="doSearch" />
    ...
    >
      <template v-slot="{doSave, preferenceData, headerDragend}">
        ...
        >
          ...
          <!-- 显示的字段-->
          <base-handler-mapping-controller-columns :show-fields="showFields" :url-methods="conf.urlMethods" @success="doSearch" />
          <el-table-column
            fixed="right"
          ...
          >
            ...
            <template slot-scope="scopeRow">
              <div class="col-btn-display">
                <!-- 更新 -->
                <base-handler-mapping-controller-update
                  v-permission="['baseHandlerMappingController:update']"
                  :value="scopeRow.row"
                ...
                <!-- 删除-->
                <del-btn
                  v-permission="['baseHandlerMappingController:delete']"
                ...
                />
                <!-- 查看 -->
                <base-handler-mapping-controller-detail
                  :value="scopeRow.row"
                />
              </div>
            </template>
...
<script>
    ...
    import BaseHandlerMappingControllerAdd from './add'
    ...
    import BaseHandlerMappingControllerUpdate from './update'
    ...
    import BaseHandlerMappingControllerDetail from './detail'
    import BaseHandlerMappingControllerColumns from './baseHandlerMappingControllerColumns'
    ...
    export default {
        name: 'BaseHandlerMappingControllerIndexVue',
        components: {
          SectionTableColumn,
          TemplateConfirmBtn,
          BaseHandlerMappingControllerColumns,
          BaseHandlerMappingControllerDetail,
            CurdTableColumnSelect,
            DelBtn,
          BaseHandlerMappingControllerUpdate,
            CurdPagination,
            HfTable, BaseHandlerMappingControllerAdd,
          FormItemColDict,
          FormItemCol,
          SimpleSearch,
