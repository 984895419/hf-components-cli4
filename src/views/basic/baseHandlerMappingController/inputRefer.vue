  ...
  <div>
    ...
    >
      <div style="margin-top: 10px">
        ...
        >
          <!-- 显示的字段-->
          <base-handler-mapping-controller-columns
...
<script>
    ...
    export default {
        name: 'BaseHandlerMappingControllerInputRefer',
        components: { BaseHandlerMappingControllerColumns, CurdPagination, HfTable, SimpleSearch,
          FormItemColDict,
          FormItemCol,
          RowSpanSlot },
        props: {
