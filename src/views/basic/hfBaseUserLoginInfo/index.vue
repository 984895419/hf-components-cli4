<template>
  <el-card class="app-container">
    ...
    <div style="margin-bottom: 10px" class="col-btn-display">
      <hf-base-user-login-info-add :action-url="conf.urlMethods.addUrl" @success="doSearch" />
    ...
    >
      <template v-slot="{doSave, preferenceData, headerDragend}">
        ...
        >
          ...
          <!-- 显示的字段-->
          <hf-base-user-login-info-columns :show-fields="showFields" :url-methods="conf.urlMethods" @success="doSearch" />
          <el-table-column
            fixed="right"
          ...
          >
            ...
            <template slot-scope="scopeRow">
              <div class="col-btn-display">
                <!-- 更新 -->
                <hf-base-user-login-info-update
                  v-permission="['hfBaseUserLoginInfo:update']"
                  :value="scopeRow.row"
                ...
                <!-- 删除-->
                <del-btn
                  v-permission="['hfBaseUserLoginInfo:delete']"
                ...
                />
                <!-- 查看 -->
                <hf-base-user-login-info-detail
                  :value="scopeRow.row"
                />
              </div>
            </template>
...
<script>
    ...
    import HfBaseUserLoginInfoAdd from './add'
    ...
    import HfBaseUserLoginInfoUpdate from './update'
    ...
    import HfBaseUserLoginInfoDetail from './detail'
    import HfBaseUserLoginInfoColumns from './hfBaseUserLoginInfoColumns'
    ...
    export default {
        name: 'HfBaseUserLoginInfoIndexVue',
        components: {
          SectionTableColumn,
          TemplateConfirmBtn,
          HfBaseUserLoginInfoColumns,
          HfBaseUserLoginInfoDetail,
            CurdTableColumnSelect,
            DelBtn,
          HfBaseUserLoginInfoUpdate,
            CurdPagination,
            HfTable, HfBaseUserLoginInfoAdd,
          FormItemColDict,
          FormItemCol,
          SimpleSearch,
