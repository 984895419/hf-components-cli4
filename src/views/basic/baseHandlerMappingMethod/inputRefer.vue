  ...
  <div>
    ...
    >
      <div style="margin-top: 10px">
        ...
        >
          <!-- 显示的字段-->
          <base-handler-mapping-method-columns
...
<script>
    ...
    export default {
        name: 'BaseHandlerMappingMethodInputRefer',
        components: { BaseHandlerMappingMethodColumns, CurdPagination, HfTable, SimpleSearch,
          FormItemColDict,
          FormItemCol,
          RowSpanSlot },
        props: {
