...
<script>
    ...
    import BaseJobInfoAdd from './add'
    ...
    import BaseJobInfoUpdate from './update'
    ...
    import BaseJobInfoDetail from './detail'
    import BaseJobInfoColumns from './baseJobInfoColumns'
