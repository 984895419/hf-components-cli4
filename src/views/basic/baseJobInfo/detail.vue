    ...
    <el-form ref="form" :model="value">
      <row-span-slot>
        <template v-slot="{ span }">
                    <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="jobId" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="jobName" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="jobDescription" />
          ...
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="runState" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="finishTime" />
        </template>
      </row-span-slot>
    </el-form>
  </common-dialog-btn>
