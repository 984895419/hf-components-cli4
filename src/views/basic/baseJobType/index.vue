<template>
  <el-card class="app-container">
    ...
    <div style="margin-bottom: 10px" class="col-btn-display">
      <base-job-type-add :action-url="conf.urlMethods.addUrl" @success="doSearch" />
    ...
    >
      <template v-slot="{doSave, preferenceData, headerDragend}">
        ...
        >
          ...
          <!-- 显示的字段-->
          <base-job-type-columns :show-fields="showFields" :url-methods="conf.urlMethods" @success="doSearch" />
          <el-table-column
            fixed="right"
          ...
          >
            ...
            <template slot-scope="scopeRow">
              <div class="col-btn-display">
                <!-- 更新 -->
                <base-job-type-update
                  v-permission="['baseJobType:update']"
                  :value="scopeRow.row"
                ...
                <!-- 删除-->
                <del-btn
                  v-permission="['baseJobType:delete']"
...
<script>
    ...
    import BaseJobTypeAdd from './add'
    ...
    import BaseJobTypeUpdate from './update'
    ...
    import BaseJobTypeDetail from './detail'
