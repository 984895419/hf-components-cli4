<template>
  <el-card class="app-container">
    ...
    <div style="margin-bottom: 10px" class="col-btn-display">
      <hf-base-right-role-user-add :action-url="conf.urlMethods.addUrl" @success="doSearch" />
    ...
    >
      <template v-slot="{doSave, preferenceData, headerDragend}">
        ...
        >
          ...
          <!-- 显示的字段-->
          <hf-base-right-role-user-columns :show-fields="showFields" :url-methods="conf.urlMethods" @success="doSearch" />
          <el-table-column
            fixed="right"
          ...
          >
            ...
            <template slot-scope="scopeRow">
              <div class="col-btn-display">
                <!-- 更新 -->
                <hf-base-right-role-user-update
                  v-permission="['hfBaseRightRoleUser:update']"
                  :value="scopeRow.row"
                ...
                <!-- 删除-->
                <del-btn
                  v-permission="['hfBaseRightRoleUser:delete']"
                ...
                />
                <!-- 查看 -->
                <hf-base-right-role-user-detail
                  :value="scopeRow.row"
                />
              </div>
            </template>
...
<script>
    ...
    import HfBaseRightRoleUserAdd from './add'
    ...
    import HfBaseRightRoleUserUpdate from './update'
    ...
    import HfBaseRightRoleUserDetail from './detail'
    import HfBaseRightRoleUserColumns from './hfBaseRightRoleUserColumns'
    ...
    export default {
        name: 'HfBaseRightRoleUserIndexVue',
        components: {
          SectionTableColumn,
          TemplateConfirmBtn,
          HfBaseRightRoleUserColumns,
          HfBaseRightRoleUserDetail,
            CurdTableColumnSelect,
            DelBtn,
          HfBaseRightRoleUserUpdate,
            CurdPagination,
            HfTable, HfBaseRightRoleUserAdd,
          FormItemColDict,
          FormItemCol,
          SimpleSearch,
