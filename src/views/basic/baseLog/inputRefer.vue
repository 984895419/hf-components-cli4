...
<script>
    ...
    export default {
        name: 'BaseLogInputRefer',
        components: { BaseLogColumns, CurdPagination, HfTable, SimpleSearch,
          FormItemColDict,
          FormItemCol,
          RowSpanSlot },
        props: {
            ...
            rowDbClick(row, column, event) {
                if (this.value) {
                    if (this.valueReferId) {
                        this.$set(this.value, this.valueReferId, row.reqId)
                    }
                    if (this.valueReferName) {
                        this.$set(this.value, this.valueReferName, row.requestUrl)
                    }
