    ...
    >
      <template v-slot="{doSave, preferenceData, headerDragend}">
        ...
        >
          ...
          <!-- 显示的字段-->
          <base-log-columns :show-fields="showFields" :url-methods="conf.urlMethods" @success="doSearch" />
          <el-table-column
            fixed="right"
...
<script>
    ...
    import BaseLogUpdate from './update'
    ...
    import BaseLogDetail from './detail'
    import BaseLogColumns from './baseLogColumns'
