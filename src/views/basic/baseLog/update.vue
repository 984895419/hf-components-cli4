          ...
          <template v-slot="{ errorMessage }">
            <row-span-slot>
              <template v-slot="{ span }">
                ...
                <form-item-col
                  :value="data"
                  :error="errorMessage('requestMethod')"
                  :span="span"
                  prop="requestMethod"
                  :namespace="conf.namespace"
                />
                ...
                <form-item-col
                  :value="data"
                  :error="errorMessage('requestParams')"
                  :span="span"
                  prop="requestParams"
                  :namespace="conf.namespace"
                />
                <form-item-col
                  :value="data"
                  :error="errorMessage('requestBody')"
                  :span="span"
                  prop="requestBody"
                  :namespace="conf.namespace"
                />
                ...
                <form-item-col
                  :value="data"
                  :error="errorMessage('responseStatus')"
                  :span="span"
                  prop="responseStatus"
                  :namespace="conf.namespace"
                />
