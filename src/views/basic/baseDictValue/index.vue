...
<script>
    ...
    import BaseDictValueAdd from './add'
    ...
    import BaseDictValueUpdate from './update'
    ...
    import BaseDictValueDetail from './detail'
    ...
    export default {
        name: 'BaseDictValueIndexVue',
        components: {
          SectionTableColumn,
          TemplateConfirmBtn,
          BaseDictValueColumns,
          BaseDictValueDetail,
            CurdTableColumnSelect,
            DelBtn,
          BaseDictValueUpdate,
            CurdPagination,
            HfTable, BaseDictValueAdd,
          FormItemColDict,
          FormItemCol,
          SimpleSearch,
