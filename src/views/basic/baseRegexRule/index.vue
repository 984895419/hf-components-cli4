<template>
  <el-card class="app-container">
    ...
    <div style="margin-bottom: 10px" class="col-btn-display">
      <base-regex-rule-add :action-url="conf.urlMethods.addUrl" @success="doSearch" />
    ...
    >
      <template v-slot="{doSave, preferenceData, headerDragend}">
        ...
        >
          ...
          <!-- 显示的字段-->
          <base-regex-rule-columns :show-fields="showFields" :url-methods="conf.urlMethods" @success="doSearch" />
          <el-table-column
            fixed="right"
          ...
          >
            ...
            <template slot-scope="scopeRow">
              <div class="col-btn-display">
                <!-- 更新 -->
                <base-regex-rule-update
                  v-permission="['baseRegexRule:update']"
                  :value="scopeRow.row"
                ...
                <!-- 删除-->
                <del-btn
                  v-permission="['baseRegexRule:delete']"
...
<script>
    ...
    import BaseRegexRuleAdd from './add'
    ...
    import BaseRegexRuleUpdate from './update'
    ...
    import BaseRegexRuleDetail from './detail'
    import BaseRegexRuleColumns from './baseRegexRuleColumns'
    ...
    export default {
        name: 'BaseRegexRuleIndexVue',
        components: {
          SectionTableColumn,
          TemplateConfirmBtn,
          BaseRegexRuleColumns,
          BaseRegexRuleDetail,
            CurdTableColumnSelect,
            DelBtn,
          BaseRegexRuleUpdate,
            CurdPagination,
            HfTable, BaseRegexRuleAdd,
          FormItemColDict,
          FormItemCol,
          SimpleSearch,
