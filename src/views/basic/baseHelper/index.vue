<template>
  <el-card class="app-container">
    ...
    <div style="margin-bottom: 10px" class="col-btn-display">
      <base-helper-add v-permission="[conf.namespace + ':save']" :action-url="conf.urlMethods.addUrl"  @success="doSearch" />
    ...
    <table-column-preference-setting-api-slot
      ...
      <template v-slot="{doSave, preferenceData, headerDragend}">
        ...
        >
          ...
          <!-- 显示的字段-->
          <base-helper-columns :show-fields="showFields" :url-methods="conf.urlMethods" @success="doSearch" />
          <el-table-column
            fixed="right"
...
<script>
    ...
    import BaseHelperUpdate from './update'
    ...
    import BaseHelperDetail from './detail'
    import BaseHelperColumns from './baseHelperColumns'
