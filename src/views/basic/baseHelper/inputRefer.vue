...
<script>
    ...
    export default {
        name: 'BaseHelperInputRefer',
        components: { BaseHelperColumns, CurdPagination, HfTable, SimpleSearch,
            ...
            rowDbClick(row, column, event) {
                if (this.value) {
                    if (this.valueReferId) {
                        this.$set(this.value, this.valueReferId, row.helperId)
                    }
                    if (this.valueReferName) {
                        this.$set(this.value, this.valueReferName, row.helperTitle)
                    }
