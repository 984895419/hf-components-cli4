<template>
  <el-card class="app-container">
    ...
    <div style="margin-bottom: 10px" class="col-btn-display">
      <hf-base-right-role-operate-add :action-url="conf.urlMethods.addUrl" @success="doSearch" />
    ...
    >
      <template v-slot="{doSave, preferenceData, headerDragend}">
        ...
        >
          ...
          <!-- 显示的字段-->
          <hf-base-right-role-operate-columns :show-fields="showFields" :url-methods="conf.urlMethods" @success="doSearch" />
          <el-table-column
            fixed="right"
          ...
          >
            ...
            <template slot-scope="scopeRow">
              <div class="col-btn-display">
                ...
                />
                <!-- 查看 -->
                <hf-base-right-role-operate-detail
                  :value="scopeRow.row"
                />
              </div>
            </template>
...
<script>
    ...
    import HfBaseRightRoleOperateAdd from './add'
    ...
    import HfBaseRightRoleOperateUpdate from './update'
    ...
    import HfBaseRightRoleOperateDetail from './detail'
    import HfBaseRightRoleOperateColumns from './hfBaseRightRoleOperateColumns'
    ...
    export default {
        name: 'HfBaseRightRoleOperateIndexVue',
        components: {
          SectionTableColumn,
          TemplateConfirmBtn,
          HfBaseRightRoleOperateColumns,
          HfBaseRightRoleOperateDetail,
            CurdTableColumnSelect,
            DelBtn,
          HfBaseRightRoleOperateUpdate,
            CurdPagination,
            HfTable, HfBaseRightRoleOperateAdd,
          FormItemColDict,
          FormItemCol,
          SimpleSearch,
