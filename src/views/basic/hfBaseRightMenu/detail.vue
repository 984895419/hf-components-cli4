    ...
    <el-form ref="form" :model="value">
      <row-span-slot>
        <template v-slot="{ span }">
          ...
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="menuName" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="menuType" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="i18nMenuName" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="controllerId" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="icon" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="redirect" />
