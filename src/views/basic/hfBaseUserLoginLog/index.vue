...
<script>
    ...
    import HfBaseUserLoginLogAdd from './add'
    ...
    import HfBaseUserLoginLogUpdate from './update'
    ...
    import HfBaseUserLoginLogDetail from './detail'
    import HfBaseUserLoginLogColumns from './hfBaseUserLoginLogColumns'
    ...
    export default {
        name: 'HfBaseUserLoginLogIndexVue',
        components: {
          SectionTableColumn,
          TemplateConfirmBtn,
          HfBaseUserLoginLogColumns,
          HfBaseUserLoginLogDetail,
            CurdTableColumnSelect,
            DelBtn,
          HfBaseUserLoginLogUpdate,
            CurdPagination,
            HfTable, HfBaseUserLoginLogAdd,
          FormItemColDict,
          FormItemCol,
          SimpleSearch,
