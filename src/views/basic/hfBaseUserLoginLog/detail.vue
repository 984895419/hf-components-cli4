    ...
    <el-form ref="form" :model="value">
      <row-span-slot>
        <template v-slot="{ span }">
          ...
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="loginType" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="loginTime" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="lastLoginIp" />
          <form-item-text :span="span" :namespace="conf.namespace" :value="value" prop="lastLoginFinger" />
        </template>
      </row-span-slot>
    </el-form>
  </common-dialog-btn>
